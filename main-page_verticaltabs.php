...
function opensubtab(evt, tabname, tabindex) {
  ...
  for (i = 0; i < subtablinks1.length; i++) {
    ...
    subtablinks1[i].style.top = y-40 +(i*40)+ "px";
    subtablinks1[i].style.left = x-2 + "px";
    subtablinks1[i].style.width = "200px";
  ...
  for (i = 0; i < subtablinks2.length; i++) {
    ...
    subtablinks2[i].style.top = y-40 +(i*40)+ "px";
    subtablinks2[i].style.left = x-2 + "px";
    subtablinks2[i].style.width = "200px";
    if (tabindex==2) subtablinks2[i].style.display = "block";
  }
   subtablinks3 = document.getElementsByClassName("subtablinks3");
  for (i = 0; i < subtablinks3.length; i++) {
    subtablinks3[i].style.position = "absolute"
    subtablinks3[i].style.top = y-40 +(i*40)+ "px";
    subtablinks3[i].style.left = x-2 + "px";
    subtablinks3[i].style.width = "200px";
