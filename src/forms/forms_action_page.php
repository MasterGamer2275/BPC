...
<?php if ($_POST["PSInumber"] != "") {  ?>
  ...
  <?php foreach ($tableData as $row) { ?>
        ...
        <?php dbaddstockrecord($db, $tablename, $myArray[2], $InvNum, $myArray[3], $myArray[4], $myArray[6], $myArray[7], $myArray[8], $myArray[9], $myArray[10], $myArray[11], $myArray[12], $myArray[14], $text); ?>
        <?php  } ?>
      <?php $i = $i+1; ?>
  <?php } ?>
